...
def test_mode_product():
    ...
    output1 = qmf.mode_product(tensor, matrix, 2, False)
    print("test_mode_product: OK")

    matrix = torch.rand(7, 3)
    output2 = qmf.mode_product(tensor, matrix, 2, True)
    print("test_mode_product: OK")
...
def test_multi_mode_product():
    ...
    output1 = qmf.multi_mode_product(tensor, matrices, transpose=False)
